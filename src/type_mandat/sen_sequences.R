...
png(file.path(plots.folder, "senateurs" ,"sen_seqIplot.png"))
seqIplot(
  sd, 
  sortv="from.start", 
  ylas=2,
...
png(file.path(plots.folder, "senateurs" ,"sen_seqIplot_ahisto.png"))
seqIplot(
  sd.left, 
  sortv="from.start", 
  ylas=2,
...
png(file.path(plots.folder, "senateurs" ,"sen_seqdplot.png"))
seqdplot(
  sd,
  border=NA,
  with.legend=FALSE
...
png(file.path(plots.folder, "senateurs" ,"sen_seqdplot2.png"))
seqdplot(
  sd.left,
  border=NA,
  with.legend=FALSE
...
png(file.path(plots.folder, "senateurs" ,"sen_seq_more_freq.png"))
seqfplot(
  sd,
  with.legend=FALSE,
  with.missing=FALSE
...
png(file.path(plots.folder, "senateurs" ,"sen_seq_more_freq_ahisto.png"))
seqfplot(
  sd.left,
  with.legend=FALSE,
  with.missing=FALSE
...
png(file.path(plots.folder, "senateurs" ,"sen_entropy.png"))
hist(sd.ent,
     col="orange",
     main=NULL,
     xlab="Entropy")
...
png(file.path(plots.folder, "senateurs" ,"sen_dendrogram.png"))
...
#Une autre au dessus de 125 pour couper 3 fois
...
png(file.path(plots.folder, "senateurs" ,"sen_Typologie_3.png"))	# cree un fichier contenant le graphique
seqdplot(
  sd,
  group=seq.part3,
  border=NA,
...
png(file.path(plots.folder, "senateurs" ,"sen_sequences_classes_3.png"))
seqIplot(
  sd,
  group=seq.part3,
)
...
png(file.path(plots.folder, "senateurs" ,"sen_sequences_classes_cmdscale_3.png"))
seqIplot(
  sd,
  group=seq.part3,
  sortv=ordre,
...
png(file.path(plots.folder, "senateurs" ,"Typologie_a-histo_3.png"))	# cree un fichier contenant le graphique
seqdplot(
  sd.left,
  group=seq.part3,
  border=NA,
...
png(file.path(plots.folder, "senateurs" ,"sen_sequences_classes_a-histo_3.png"))
seqIplot(
  sd.left,
  group=seq.part3,
)
...
png(file.path(plots.folder, "senateurs" ,"sen_repartition_etats_classes_3.png"))
seqmtplot(sd,
          group=seq.part3,
          border=NA)
dev.off()

png(file.path(plots.folder, "senateurs" ,"sen_repartition_etats_classes_a-histo_3.png"))
seqmtplot(
  sd.left,
  group=seq.part3,
  border=NA)
...
png(file.path(plots.folder, "senateurs" ,"sen_entropie_transversale_3.png"))
seqHtplot(
  sd, 
  group=seq.part3
)
...
# Le nombre de divers dans les classes : 
assoc.twocat(factor(seq.part3),
             factor(repr.all[,"senartementDeNaissance"]))
...
# 1ere tentative de typologie - sequences en tapis :
png(file.path(plots.folder, "senateurs" ,"sen_Typologie_5.png"))	# cree un fichier contenant le graphique
seqdplot(
  sd,
  group=seq.part5,
  border=NA,
...
png(file.path(plots.folder, "senateurs" ,"sen_sequences_classes_5.png"))
seqIplot(
  sd,
  group=seq.part5,
)
