...
png(file.path(plots.folder, "deputes" ,"dep_seqIplot.png"))
seqIplot(
  sd, 
  sortv="from.start", 
  ylas=2,
...
png(file.path(plots.folder, "deputes" ,"dep_seqIplot_ahisto.png"))
seqIplot(
  sd.left, 
  sortv="from.start", 
  ylas=2,
...
png(file.path(plots.folder, "deputes" ,"dep_seqdplot.png"))
seqdplot(
  sd,
  border=NA,
  with.legend=FALSE
...
png(file.path(plots.folder, "deputes" ,"dep_seqdplot2.png"))
seqdplot(
  sd.left,
  border=NA,
  with.legend=FALSE
...
png(file.path(plots.folder, "deputes" ,"dep_seq_more_freq.png"))
seqfplot(
  sd,
  with.legend=FALSE,
  with.missing=FALSE
...
png(file.path(plots.folder, "deputes" ,"dep_seq_more_freq_ahisto.png"))
seqfplot(
  sd.left,
  with.legend=FALSE,
  with.missing=FALSE
...
png(file.path(plots.folder, "deputes" ,"dep_entropy.png"))
hist(sd.ent,
     col="orange",
     main=NULL,
     xlab="Entropy")
...
png(file.path(plots.folder, "deputes" ,"dep_dendrogram.png"))
...
png(file.path(plots.folder, "deputes" ,"dep_Typologie_3.png"))	# cree un fichier contenant le graphique
seqdplot(
  sd,
  group=seq.part3,
  border=NA,
...
png(file.path(plots.folder, "deputes" ,"dep_sequences_classes_3.png"))
seqIplot(
  sd,
  group=seq.part3,
)
...
png(file.path(plots.folder, "deputes" ,"dep_sequences_classes_cmdscale_3.png"))
seqIplot(
  sd,
  group=seq.part3,
  sortv=ordre,
...
png(file.path(plots.folder, "deputes" ,"Typologie_a-histo_3.png"))	# cree un fichier contenant le graphique
seqdplot(
  sd.left,
  group=seq.part3,
  border=NA,
...
png(file.path(plots.folder, "deputes" ,"dep_sequences_classes_a-histo_3.png"))
seqIplot(
  sd.left,
  group=seq.part3,
)
...
png(file.path(plots.folder, "deputes" ,"dep_repartition_etats_classes_3.png"))
seqmtplot(sd,
          group=seq.part3,
          border=NA)
dev.off()

png(file.path(plots.folder, "deputes" ,"dep_repartition_etats_classes_a-histo_3.png"))
seqmtplot(
  sd.left,
  group=seq.part3,
  border=NA)
...
png(file.path(plots.folder, "deputes" ,"dep_entropie_transversale_3.png"))
seqHtplot(
  sd, 
  group=seq.part3
)
...
# 1ere tentative de typologie - sequences en tapis :
png(file.path(plots.folder, "deputes" ,"dep_Typologie_5.png"))	# cree un fichier contenant le graphique
seqdplot(
  sd,
  group=seq.part5,
  border=NA,
...
png(file.path(plots.folder, "deputes" ,"dep_sequences_classes_5.png"))
seqIplot(
  sd,
  group=seq.part5,
)
