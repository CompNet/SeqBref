...
png(file.path(plots.folder, "departements" ,"ain_seqIplot.png"))
seqIplot(
  sd, 
  sortv="from.start", 
  ylas=2,
...
png(file.path(plots.folder, "departements" ,"ain_seqIplot_ahisto.png"))
seqIplot(
  sd.left, 
  sortv="from.start", 
  ylas=2,
...
png(file.path(plots.folder, "departements" ,"ain_seqdplot.png"))
seqdplot(
  sd,
  border=NA,
  with.legend=FALSE
...
png(file.path(plots.folder, "departements" ,"ain_seqdplot2.png"))
seqdplot(
  sd.left,
  border=NA,
  with.legend=FALSE
...
png(file.path(plots.folder, "departements" ,"ain_seq_more_freq.png"))
seqfplot(
  sd,
  with.legend=FALSE,
  with.missing=FALSE
...
png(file.path(plots.folder, "departements" ,"ain_seq_more_freq_ahisto.png"))
seqfplot(
  sd.left,
  with.legend=FALSE,
  with.missing=FALSE
...
png(file.path(plots.folder, "departements" ,"ain_entropy.png"))
hist(sd.ent,
     col="orange",
     main=NULL,
     xlab="Entropy")
...
png(file.path(plots.folder, "departements" ,"ain_dendrogram.png"))
