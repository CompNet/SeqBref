...
png(file.path(plots.folder, "departements" ,"bdr_seqIplot.png"))
seqIplot(
  sd, 
  sortv="from.start", 
  ylas=2,
...
png(file.path(plots.folder, "departements" ,"bdr_seqIplot_ahisto.png"))
seqIplot(
  sd.left, 
  sortv="from.start", 
  ylas=2,
...
png(file.path(plots.folder, "departements" ,"bdr_seqdplot.png"))
seqdplot(
  sd,
  border=NA,
  with.legend=FALSE
...
png(file.path(plots.folder, "departements" ,"bdr_seqdplot2.png"))
seqdplot(
  sd.left,
  border=NA,
  with.legend=FALSE
...
png(file.path(plots.folder, "departements" ,"bdr_seq_more_freq.png"))
seqfplot(
  sd,
  with.legend=FALSE,
  with.missing=FALSE
...
png(file.path(plots.folder, "departements" ,"bdr_seq_more_freq_ahisto.png"))
seqfplot(
  sd.left,
  with.legend=FALSE,
  with.missing=FALSE
...
png(file.path(plots.folder, "departements" ,"bdr_entropy.png"))
hist(sd.ent,
     col="orange",
     mbdr=NULL,
     xlab="Entropy")
...
png(file.path(plots.folder, "departements" ,"bdr_dendrogram.png"))
...
dev.off()
# Je trace une ligne verticale legermenet au dessus de 175 et coupe bdrsi 8 fois une ligne verticale
