...
png(file.path(plots.folder, "departements" ,"ssd_seqIplot.png"))
seqIplot(
  sd, 
  sortv="from.start", 
  ylas=2,
...
png(file.path(plots.folder, "departements" ,"ssd_seqIplot_ahisto.png"))
seqIplot(
  sd.left, 
  sortv="from.start", 
  ylas=2,
...
png(file.path(plots.folder, "departements" ,"ssd_seqdplot.png"))
seqdplot(
  sd,
  border=NA,
  with.legend=FALSE
...
png(file.path(plots.folder, "departements" ,"ssd_seqdplot2.png"))
seqdplot(
  sd.left,
  border=NA,
  with.legend=FALSE
...
png(file.path(plots.folder, "departements" ,"ssd_seq_more_freq.png"))
seqfplot(
  sd,
  with.legend=FALSE,
  with.missing=FALSE
...
png(file.path(plots.folder, "departements" ,"ssd_seq_more_freq_ahisto.png"))
seqfplot(
  sd.left,
  with.legend=FALSE,
  with.missing=FALSE
...
png(file.path(plots.folder, "departements" ,"ssd_entropy.png"))
hist(sd.ent,
     col="orange",
     mssd=NULL,
     xlab="Entropy")
...
png(file.path(plots.folder, "departements" ,"ssd_dendrogram.png"))
...
dev.off()
# Je trace une ligne verticale legermenet au dessus de 175 et coupe ssdsi 8 fois une ligne verticale
