...
CAT_COLORS_12 <- c(							# manually extended color brewer palette
	...
	rgb(166,86,40,maxColorValue=255),		# brown
	rgb(152,78,163,maxColorValue=255),		# purple
	rgb(156,21,14,maxColorValue=255),		# dark red
...
STATE_COLORS <- c(
	"A"=rgb(55,126,184,maxColorValue=255),		# blue
	"CD"=rgb(0,255,255,maxColorValue=255),		# cyan
	"CM"=rgb(113,219,110,maxColorValue=255),	# light green
	"CR"=rgb(55,126,184,maxColorValue=255),		# blue
	"CuL"=rgb(16,125,12,maxColorValue=255),		# dark green
	"CuV"=rgb(228,26,28,maxColorValue=255),		# red
	"CuR"=rgb(166,86,40,maxColorValue=255),		# brown
	"D"=rgb(255,127,0,maxColorValue=255),		# orange
	"DM"="BLACK",
	"FM"="BLACK",
	"M"=rgb(0,255,255,maxColorValue=255),		# cyan
	"Ma"=rgb(55,126,184,maxColorValue=255),		# blue
	"P"=rgb(156,21,14,maxColorValue=255),		# dark red
	"L"=rgb(16,125,12,maxColorValue=255),		# dark green
	"RE"=rgb(247,129,191,maxColorValue=255),	# pink
	"S"=rgb(255,255,51,maxColorValue=255),		# yellow
	"Sup"=rgb(30,30,30,maxColorValue=255),		# dark grey
	"VP"=rgb(152,78,163,maxColorValue=255)		# purple
)
